...
if __name__ == "__main__":
    logger.info("Starting {} {} on port {} ({} routes)", ENGINE_ID, ENGINE_NAME, ENGINE_PORT, len(app.routes))
    uvicorn.run(app, host="0.0.0.0", port=ENGINE_PORT, reload=False, log_level="info")
